...
//     {
//         id: 1,
//         title: "Posse. - Event Planning App",
//         img:
//           "assets/Posse.png"
//       }
// ];
...
export const webPortfolio = [
    {
      id: 1,
      title: "Posse. - Event Planning App",
      description: "Posse is a social networking event planning web app. Users login or create an account and they are then given the option to create an event as a host, or accept event invites as a guest. Each event page has information about the event, and there is also a newsfeed on each event page where hosts and guests can post comments and questions. If there is a post created by a guest or a host on an event page, the user will get a text message sent to their mobile device alerting them about the update and prompting them to check their account.",
      img:  "assets/Posse.png"
    }
];
...
export const mobilePortfolio = [
        {
          id: 1,
          title: "Coming Soon!",
          img: "assets/workinprogress.jpeg"
        },
    ];
...
//EXAMPLES FOR WHEN MORE PROJECTS NEED TO BE ADDED TO PORTFOLIO
// export const featuredPortfolio = [
//     {
//       id: 1,
